      ...
      <div
        ...
        aria-label={
          engine === 'agentcore'
            ...
            : 'AWS architecture, hand-built engine: browser through CloudFront, ALB and Fargate to Bedrock, DynamoDB and the external integration APIs'
        }
      >
        <svg
          width={AWS_DIAGRAM_CANVAS.width}
        ...
        {AWS_TIER_LABELS.filter(
          (tier) => tier.engine === undefined || tier.engine === engine,
        ).map((tier) => (
